...
public class RecipeWidgetProviderConfigureActivity extends Activity {
    ...
    static String loadRecipePref(Context context, int appWidgetId) {
        ...
        return prefs.getString(PREF_PREFIX_KEY + appWidgetId, String.valueOf(DEFAULT_NO_SELECTION));
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        mAppWidgetText.setText(loadRecipePref(RecipeWidgetProviderConfigureActivity.this, mAppWidgetId));
    }
}
