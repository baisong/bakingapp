 ...
 * Usage:
 *
 * int sampleInt = State.getInstance(context).getInt(Key.SAMPLE_INT);
 * State.getInstance(context).set(Key.SAMPLE_INT, sampleInt);
 *
 * If State.getInstance(Context) has been called once, you can
 * simple use State.getInstance() to save some precious line space.
 *
 * Source: https://gist.github.com/alphamu/8748537a3b73d9c58b4c
 *
 * Maybe consider this? https://github.com/GrenderG/Prefs
 */
public class State {
